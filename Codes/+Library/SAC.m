...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This function calculates the shuffled autocorrelation, which is a
% all-order shuffled autocorrelogram. The correlogram is calculated using
% the same stimuli and multiple repetitions.
%
% Input:
...
for iStandard = 1:size(SpTrain,2)
