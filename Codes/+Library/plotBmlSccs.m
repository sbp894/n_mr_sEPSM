function plotBmlSccs(DATAfilename)
% File: plot_BML_SCCs

%% SAVE BML Data
disp(sprintf('LOADING BML Data: %s_BML.mat',DATAfilename))
eval(['load ' DATAfilename sprintf('.mat')])
...
plot(BMLdata.OALevel_dBSPL_VEC,BMLdata.CCCenv_IFFTadjSC,'r-'); hold off
ylabel(texlabel('rho_{ENV}'))
h5=legend('IFFT-0','Location','best');
