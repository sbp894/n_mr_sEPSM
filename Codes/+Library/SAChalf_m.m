function [NSAC,delay,AVGrate,TOTALspikes] = SAChalf_m(SpikeTrain1,DELAYbinwidth,Duration)
% File: SAChalf
% 21 Jun, 2017: SP
% Calls: SAChalf.c (mex)
...
[intsMEX,delay] = Library.SAChalf(SpikeMAT',NUMspikes,TOTALspikes,Duration, DELAYbinwidth);
