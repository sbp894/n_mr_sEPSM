...
% This file is part of LTFAT version 1.0.2
...
[flags,kv]=Library.ltfatarghelper({},definput,varargin);
...
[f,L,Ls,W,dim,permutedsize,order]=Library.assert_sigreshape_pre(f,[],kv.dim, ...
                                                  upper(mfilename));
permutedsize(1)=1;
...
y=Library.assert_sigreshape_post(y,kv.dim,permutedsize,order);
