...
PowerMod_Snorm=(PowerMod_S-PowerMod_S_noisefloor)./PowerMod_S_noisefloor;
PowerMod_Nnorm=(PowerMod_N-PowerMod_N_noisefloor)./PowerMod_N_noisefloor;
PowerMod_SNnorm=(PowerMod_SN-PowerMod_SN_noisefloor)./PowerMod_SN_noisefloor;
